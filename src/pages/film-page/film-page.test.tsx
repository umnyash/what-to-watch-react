...
describe('Component: FilmPage', () => {
  ...
  it('should render FilmPageContent when hook returns film data', () => {
    ...
    expect(FilmPageContent).toHaveBeenCalledOnce();
    expect(FilmPageContent).toHaveBeenCalledWith(
      { film: mockFilm },
      expect.anything()
    );
  ...
  it('should render ErrorPage when hook returns load error without 404 status', () => {
    ...
    expect(LoadingPage).not.toHaveBeenCalled();
    expect(FilmPageContent).not.toHaveBeenCalled();
    expect(NotFoundPage).not.toHaveBeenCalled();
  });
